...
const vaccineData = [
  ...
  {
    id: "dtp",
    name: "Diphtheria - Pertussis - Tetanus (DTP)",
    image: blogImg2,
    details: [
  ...
  },
  {
    ...
    name: "Hepatitis B",
    image: blogImg3,
    details: ["Causes liver cirrhosis and liver cancer.", "Vaccinate within 24 hours after birth."],
    schedule: "First dose at birth, with follow-up doses at 1-2 months and 6-18 months.",
    additionalInfo:
  ...
  },
  {
    ...
    image: blogImg4,
    details: ["Causes purulent meningitis in young children.", "Usually included in 5-in-1 or 6-in-1 vaccines."],
...
const Resources = () => {
  ...
  const VaccineCard = ({ vaccine, index, isVisible, onClick }) => {
    ...
    return (
      <div
        className={`vaccine-card ${isVisible ? "visible" : ""} ${isHovered ? "hovered" : ""}`}
        onClick={onClick}
      ...
      >
        ...
        <div className="card-image">
          ...
          <img src={vaccine.image || "/placeholder.svg?height=200&width=300"} alt={vaccine.name} />
        </div>
    ...
    <div className="vaccine-container">
      <section className="vaccine-section">
        ...
        <div className="container">
          <div
            className={`hero-section ${visibleElements.has("hero-section") ? "animate-in" : ""}`}
          ...
          >
            ...
            <p className="hero-subtitle">
              Vaccination is one of the most effective measures to prevent dangerous infectious diseases, helping
              protect both individual and community health in our school environment.
            </p>

            <div
              className={`hero-stats ${visibleElements.has("hero-stats") ? "animate-in" : ""}`}
          ...
          <div
            className={`section-intro ${visibleElements.has("section-intro") ? "animate-in" : ""}`}
            ref={(el) => observeElement(el, "section-intro")}
          >
            <h2 className="intro-title">Essential Vaccines for School Health</h2>
            <p className="intro-description">
              Click on any vaccine card below to learn more about its importance, schedule, and benefits for your
              child's health.
            </p>
          </div>

          <div className="vaccines-grid" ref={(el) => observeElement(el, "vaccines-grid")}>
          ...
          <div
            className={`section-footer ${visibleElements.has("section-footer") ? "animate-in" : ""}`}
          ...
          >
            <div className="footer-content">
              ...
              <div className="footer-text">
                ...
                <p>
                  Please follow the vaccination schedule and get fully vaccinated to protect your own health and the
                  community. Consult with healthcare professionals for personalized advice.
                </p>
              </div>
            </div>
      ...
      {selectedVaccine && <VaccineModal vaccine={selectedVaccine} onClose={closeModal} />}
    </div>
  );
};
