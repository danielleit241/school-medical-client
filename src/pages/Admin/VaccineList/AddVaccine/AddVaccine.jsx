...
const AddVaccine = () => {
  ...
  return (
    <div className="container">
          <h3 style={{ marginBottom: 16 }}>Import file Vaccination Inventory here</h3>
          ...
          {data.length > 0 && (() => {
            ...
            const header = data[0] || [];
            const expirationDateCol = header.findIndex(
              h => String(h).toLowerCase().includes("expirationdate")
            );
