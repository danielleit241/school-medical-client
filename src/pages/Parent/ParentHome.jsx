  ...
  return (
    <>
      <div className="container">
        <div className="home__content bg-white p-[50px]">
          ...
          <div className="home__content-main">
            <div className="home__content-left">
              <div className="home__content-menu  bg-white">
              ...
              <div className="home__content-features">
                <ul className="flex flex-col gap-4">
                  <li className="flex items-center gap-2">
                    ...
                    <div className="text-[16px]">A Passion for Healing</div>
                  </li>
                  <li className="flex items-center gap-2">
                    <GoDotFill size={35} color="#159eec" />
                    <div className="text-[16px]">All our best</div>
                  </li>
                  <li className="flex items-center gap-2">
                    <GoDotFill size={35} color="#159eec" />
                    <div className="text-[16px]">A Legacy of Excellence</div>
                  </li>
                </ul>
                <ul className="flex flex-col gap-4">
                  <li className="flex items-center gap-2">
                    <GoDotFill size={35} color="#159eec" />
                    <div className="text-[16px]">5-Star Care</div>
                  </li>
                  <li className="flex items-center gap-2">
                    <GoDotFill size={35} color="#159eec" />
                    <div className="text-[16px]">Believe in Us</div>
                  </li>
                  <li className="flex items-center gap-2">
                    <GoDotFill size={35} color="#159eec" />
                    <div className="text-[16px]">Always Caring</div>
                  </li>
                </ul>
              </div>
              <p>
                ...
                passion drives healthcare professionals to listen attentively,
                communicate clearly, and provide compassionate care tailored to
                the specific needs of every patient. When patients feel truly
                valued and understood, it builds trust, reduces anxiety, and
        ...
        <div className="home__services bg-white p-[50px]">
          <div className="home__content-header">
