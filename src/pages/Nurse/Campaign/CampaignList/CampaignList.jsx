...
const CampaignList = () => {
  ...
  const [studentCounts, setStudentCounts] = useState({}); // { [roundId]: count }
    ...
    const fetchCounts = async () => {
      ...
      await Promise.all(
        rounds.map(async (round) => {
          try {
            const res = await axiosInstance.get(
              `/api/nurses/${staffNurseId}/vaccination-rounds/${round.roundId}/students`,
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: `0 48px 32px 48px`, // <-- bỏ padding top
                      marginBottom: 32,
                      width: "100%",
                      maxWidth: "100%",
                      marginLeft: 0,
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      alignItems: "center",
                      gap: 18,
                      marginTop: idx === 0 ? 0 : 0 // <-- đảm bảo không có margin top ở round đầu tiên
                    }}>
